...
import CreatePurchaseMedicine from "./CreatePurchaseMedicine";
...
const PurchaseReturn = () => {  
  ...
  const getData = () => {
    axios
      .get("http://192.168.18.41:3002/medicine/getAll")
      .then((res) => {
          ...
          <div className="card">
            <div className="card-body">
              <div className="text-end mb-3">
                <a onClick={() => setModalOpen(true)} className="new_Warehouse btn btn-outline-primary btn-md m-1">
